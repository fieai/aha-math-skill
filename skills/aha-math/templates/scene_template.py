...
渲染：
  bash scripts/check_text.py <主题>/scene.py     # 先查字体方框
  bash scripts/render.sh   <主题>/scene.py AhaMath s   # 静帧
  bash scripts/render.sh   <主题>/scene.py AhaMath m   # 草稿
"""
from manim import *
